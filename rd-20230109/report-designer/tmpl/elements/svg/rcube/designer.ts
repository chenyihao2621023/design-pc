...
export default Designer.extend({
    ...
    props: [
        ...
        DesignerProvider['@:{designer#shared.props.color}']('@:{lang#props.front.color}', 'frontcolor', 1, 1),
        DesignerProvider['@:{designer#shared.props.color}']('@:{lang#props.side.color}', 'sidecolor', 1, 1),
        DesignerProvider['@:{designer#shared.props.spliter}'],
